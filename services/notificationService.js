...
module.exports.SendNotificationToRoom = function (company, tenant, roomName, eventName, msgData,logKey){
    try {
        ...
        httpReq.post(options, function (error, response, body)
        {
            ...
            {
                logger.error("[DVP-ARDSLiteService.SendNotificationToRoom] - [%s] - Send Notification Fail", logKey, error);
            }
        })
